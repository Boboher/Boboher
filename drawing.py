...
wn.tracer(0)
wn.addshape("start_button.gif")
wn.addshape("colors_button.gif")
wn.addshape("home_button.gif")
wn.addshape("pen_up_button.gif")
wn.addshape("pen_down_button.gif")
wn.addshape("clear_button.gif")
wn.addshape("drawing_size_up.gif")
wn.addshape("drawing_size_down.gif")
#pen
pen = turtle.Turtle()
pen.color("black")
pen.speed(0)
...
pen_up_button.shape("pen_up_button.gif")
pen_up_button.penup()
...
pen_down_button.shape("pen_down_button.gif")
