...
wn.tracer(0)
wn.addshape("D:\python\projects\start_button.gif")
wn.addshape("D:\python\projects\colors_button.gif")
wn.addshape("D:\python\projects\home_button.gif")
wn.addshape("D:\python\projects\pen_up_button.gif")
wn.addshape("D:\python\projects\pen_down_button.gif")
wn.addshape("D:\python\projects\clear_button.gif")
wn.addshape("D:\python\projects\drawing_size_up.gif")
wn.addshape("D:\python\projects\drawing_size_down.gif")
#pen
pen = turtle.Turtle()
pen.color("black")
pen.speed(0)
...
pen_up_button.shape("D:\python\projects\pen_up_button.gif")
pen_up_button.penup()
...
pen_down_button.shape("D:\python\projects\pen_down_button.gif")
...
start_button.penup()
start_button.shape("D:\python\projects\start_button.gif")
start_button.goto(0, -220)

#colors button
colors_button = turtle.Turtle()
colors_button.penup()
colors_button.shape("D:\python\projects\colors_button.gif")
colors_button.goto(0, 220)

#home button
home_button = turtle.Turtle()
home_button.penup()
home_button.shape("D:\python\projects\home_button.gif")
home_button.goto(-380, 280)
home_button.hideturtle()

#clear button
clear_button = turtle.Turtle()
clear_button.shape("D:\python\projects\clear_button.gif")
clear_button.penup()
...
drawing_size_up.shape("D:\python\projects\drawing_size_up.gif")
drawing_size_up.goto(210, -220)
drawing_size_up.hideturtle()

drawing_size_down = turtle.Turtle()
drawing_size_down.penup()
drawing_size_down.shape("D:\python\projects\drawing_size_down.gif")
